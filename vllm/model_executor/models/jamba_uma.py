...
JambaMoeSourcePlan = RoutedMoeSourcePlan


def _parse_jamba_routed_expert_name(
    name: str,
...
def _routed_param_for_projection(
    ...
    raise ValueError(f"Unsupported Jamba routed expert projection {proj_name!r}")
...
def build_jamba_moe_weight_plan(
    ...
    *,
    ...
    return build_routed_moe_weight_plan(
        ...
        parse_name=_parse_jamba_routed_expert_name,
