...
AfmoeMoeSourcePlan = RoutedMoeSourcePlan


def _parse_afmoe_routed_expert_name(
    name: str,
...
def _routed_param_for_projection(proj_name: str, suffix: str) -> tuple[str, str]:
    ...
    raise ValueError(f"Unsupported AFMoE routed expert projection {proj_name!r}")
...
def build_afmoe_moe_weight_plan(
    ...
    *,
    ...
    return build_routed_moe_weight_plan(
        ...
        catalog,
        family_name="AFMoE",
        parse_name=_parse_afmoe_routed_expert_name,
