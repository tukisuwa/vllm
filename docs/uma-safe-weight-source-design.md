...
- `vllm/model_executor/models/auto_uma.py`
  ...
  - is used by Qwen2, Qwen3, Llama, Gemma, Gemma2, Gemma3, InternLM2, OLMo,
    OLMo2, Nemotron, EXAONE, and Cohere
...
`Gemma3ForCausalLM`, `InternLM2ForCausalLM`, `OlmoForCausalLM`, `Olmo2ForCausalLM`,
...
| --- | --- | --- |
| Dense safetensors | Should work if normal vLLM load works | Phase 3 hooks for Qwen2/Qwen3/Llama/Gemma/Gemma2/Gemma3/InternLM2/OLMo/OLMo2/Nemotron/EXAONE/Cohere-style AutoWeightsLoader models |
