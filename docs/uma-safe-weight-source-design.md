...
`LlamaForCausalLM`, `OlmoForCausalLM`, `Olmo2ForCausalLM`,
...
- plan skips tied `lm_head`: implemented for Qwen2, Qwen3, Llama, OLMo,
...
| --- | --- | --- |
| Dense safetensors | Should work if normal vLLM load works | Phase 3 hooks for Qwen2/Qwen3/Llama/OLMo/OLMo2/Nemotron/EXAONE/Cohere-style AutoWeightsLoader models |
